...
(() => {
  ...
  const editorial = [
    'https://www.coppermine.is/cdn/shop/files/N4A9004.jpg?v=1783658085',
    'https://www.coppermine.is/cdn/shop/files/DSC6978.jpg?v=1757510313',
    'https://www.coppermine.is/cdn/shop/files/N4A8891.jpg?v=1783649858'
  ];
  ...
  const railST = $('#railST'); if (railST) railST.innerHTML = pick(CM.somerset).map(prod).join('');

  /* ── rolling-list categories (21st.dev rolling-list, ported) ── */
  const catData = [
    { name: 'Hoodies', count: '17', pool: CM.hoodies },
    { name: 'Knitwear', count: '05', pool: CM.knit },
    { name: 'Headwear', count: '12', pool: CM.hats },
    { name: 'Pants', count: '12', pool: CM.bottoms }
  ];
  const cats = $('#cats');
